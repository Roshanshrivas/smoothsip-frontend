...
const BestSellers = () => {
  ...
  if (isLoading) {
    return (
      <div className="w-full py-12 md:py-20 bg-[#e6f7ff]/30">
  ...
  return (
    <section ref={sectionRef} className="w-full py-2 sm:py-12 bg-[#e6f7ff]/30 overflow-hidden">
      <div className="w-full mx-auto px-3 sm:px-4 lg:px-6">
        ...
        >
          <div className="text-left">
            <div className="flex items-center gap-2 justify-center sm:justify-start">
              <h2 className="text-[21px] sm:text-3xl md:text-4xl font-extrabold text-gray-900">Best 
                <span className="text-[#02B5D1]"> Sellers</span>
              </h2>
            </div>
            <p className="text-gray-500 mt-1 text-sm md:text-base">Top picks from our happy customers</p>
          </div>
          <motion.button
        ...
        >
          ...
          {/* Products container – always visible, cards stagger on mount */}
          <motion.div
            ref={scrollRef}
        ...
        {/* Mobile View All – animated on scroll */}
        {/* <motion.div
